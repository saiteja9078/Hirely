...
import { i as require_extends, n as require_taggedTemplateLiteralLoose, r as require_objectWithoutPropertiesLoose, t as require_objectDestructuringEmpty } from "../babel__runtime.mjs";
...
var import_taggedTemplateLiteralLoose = /* @__PURE__ */ __toESM(require_taggedTemplateLiteralLoose());
/**
...
function Markdown(props) {
	...
	var mdStr = "<pre class=\"language-markdown " + prefixCls + "-text-pre wmde-markdown-color\"><code class=\"language-markdown\">" + html2Escape(String.raw(_templateObject || (_templateObject = (0, import_taggedTemplateLiteralLoose.default)(["", ""])), markdown)) + "\n</code></pre>";
...
function getCommands$1(data, resulte) {
	...
	data.forEach((item) => {
		if (item.children && Array.isArray(item.children)) resulte = (0, import_extends.default)({}, resulte, getCommands$1(item.children || []));
...
var import_objectDestructuringEmpty = /* @__PURE__ */ __toESM(require_objectDestructuringEmpty());
var group = (arr, options) => {
	var data = (0, import_extends.default)({
		children: arr,
		icon: /*#__PURE__*/ (0, import_jsx_runtime.jsx)("svg", {
			width: "12",
			height: "12",
	...
	if (Array.isArray(data.children)) data.children = data.children.map((_ref) => {
		var item = (0, import_extends.default)({}, ((0, import_objectDestructuringEmpty.default)(_ref), _ref));
		item.parent = data;
		return (0, import_extends.default)({}, item);
	});
	return data;
};
//#endregion
...
(0, import_extends.default)({}, heading1, { icon: /*#__PURE__*/ (0, import_jsx_runtime.jsx)("svg", {
	width: "12",
	height: "12",
	viewBox: "0 0 520 520",
	children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)("path", {
...
var TextAreaCommandOrchestrator = class {
	...
	executeCommand(command, dispatch, state, shortcuts) {
		command.execute && command.execute((0, import_extends.default)({ command }, getStateFromTextArea(this.textArea)), this.textApi, dispatch, state, shortcuts);
	}
};
//#endregion
...
function Textarea(props) {
	var prefixCls = props.prefixCls, _onChange = props.onChange, other = (0, import_objectWithoutPropertiesLoose.default)(props, _excluded$2), _useContext = (0, import_react.useContext)(EditorContext), markdown = _useContext.markdown, commands = _useContext.commands, fullscreen = _useContext.fullscreen, preview = _useContext.preview, highlightEnable = _useContext.highlightEnable, extraCommands = _useContext.extraCommands, tabSize = _useContext.tabSize, defaultTabEnable = _useContext.defaultTabEnable, autoFocusEnd = _useContext.autoFocusEnd, textareaWarp = _useContext.textareaWarp, dispatch = _useContext.dispatch;
	(0, import_objectWithoutPropertiesLoose.default)(_useContext, _excluded2);
	...
	return /*#__PURE__*/ (0, import_jsx_runtime.jsx)("textarea", (0, import_extends.default)({
		autoComplete: "off",
		autoCorrect: "off",
		autoCapitalize: "off",
		spellCheck: false
...
function createTextArea(options) {
	...
	return function TextArea(props) {
		var _ref = props || {}, prefixCls = _ref.prefixCls, className = _ref.className, onScroll = _ref.onScroll, renderTextarea = _ref.renderTextarea, otherProps = (0, import_objectWithoutPropertiesLoose.default)(_ref, _excluded$1);
		...
		(0, import_react.useEffect)(() => {
			...
			if (dispatch) dispatch((0, import_extends.default)({}, state));
		}, []);
		(0, import_react.useEffect)(() => {
			if (textRef.current && dispatch) {
				var commandOrchestrator = new TextAreaCommandOrchestrator(textRef.current);
		...
		return /*#__PURE__*/ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)("div", {
				...
				children: renderTextarea ? /*#__PURE__*/ import_react.cloneElement(renderTextarea((0, import_extends.default)({}, otherProps, {
					value: markdown,
					autoComplete: "off",
					autoCorrect: "off",
					spellCheck: "false",
				...
				}), { ref: textRef }) : /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [MarkdownComponent && highlightEnable && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(MarkdownComponent, { prefixCls }), /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Textarea, (0, import_extends.default)({ prefixCls }, otherProps, { style: textStyle }))] })
			})
		});
	};
}
...
function Child(props) {
	...
	return (0, import_react.useMemo)(() => /*#__PURE__*/ (0, import_jsx_runtime.jsx)("div", {
		...
		children: Array.isArray(commands) ? /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Toolbar, (0, import_extends.default)({ commands }, props, { isChild: true })) : children
	}), [
		commands,
		barPopup,
		groupName,
...
function ToolbarItems(props) {
	...
	function handleClick(command, name) {
		if (!dispatch) return;
		var state = { barPopup: (0, import_extends.default)({}, barPopup) };
		...
		if (Object.keys(state).length) dispatch((0, import_extends.default)({}, state));
	...
	return /*#__PURE__*/ (0, import_jsx_runtime.jsx)("ul", { children: (props.commands || []).map((item, idx) => {
		if (item.keyCommand === "divider") return /*#__PURE__*/ (0, import_jsx_runtime.jsx)("li", (0, import_extends.default)({}, item.liProps, { className: prefixCls + "-toolbar-divider" }), idx);
		...
		return /*#__PURE__*/ (0, import_jsx_runtime.jsxs)("li", (0, import_extends.default)({}, item.liProps, {
			className: activeBtn ? "active" : "",
			children: [
				com && /*#__PURE__*/ import_react.isValidElement(com) && com,
				!com && !item.buttonProps && item.icon,
				!com && item.buttonProps && /*#__PURE__*/ import_react.createElement("button", (0, import_extends.default)({
					type: "button",
					key: idx,
					disabled,
					"data-name": item.name
...
function Toolbar(props) {
	...
	return /*#__PURE__*/ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/*#__PURE__*/ (0, import_jsx_runtime.jsx)(ToolbarItems, (0, import_extends.default)({}, props, { commands: props.commands || commands || [] })), !isChild && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(ToolbarItems, (0, import_extends.default)({}, props, { commands: extraCommands || [] }))]
	});
}
...
function createMDEditor(options) {
	...
	var Editor = /* @__PURE__ */ import_react.forwardRef((props, ref) => {
		...
		(0, import_react.useImperativeHandle)(ref, () => (0, import_extends.default)({}, state, {
		...
		(0, import_react.useEffect)(() => {
			...
			stateInit.barPopup = {};
			if (dispatch) dispatch((0, import_extends.default)({}, state, stateInit));
		}, []);
		var cls = [
			className,
			"wmde-markdown-var",
		...
		var mdPreview = (0, import_react.useMemo)(() => /*#__PURE__*/ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)(PreviewComponent, (0, import_extends.default)({}, previewOptions, {
		...
		var containerStyle = (0, import_extends.default)({}, other.style, { height: state.height || "100%" });
		var containerClick = () => dispatch({ barPopup: (0, import_extends.default)({}, setGroupPopFalse(state.barPopup)) });
		...
		var changeHandle = (evn) => {
			...
			if (state.textarea && state.textarea instanceof HTMLTextAreaElement && onStatistics) {
				...
				onStatistics((0, import_extends.default)({}, objState, {
		...
		return /*#__PURE__*/ (0, import_jsx_runtime.jsx)(EditorContext.Provider, {
			value: (0, import_extends.default)({}, state, { dispatch }),
			children: /*#__PURE__*/ (0, import_jsx_runtime.jsxs)("div", (0, import_extends.default)({
				ref: container,
				className: cls
			}, other, {
				...
				children: [
					...
					/*#__PURE__*/ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/(edit|live)/.test(state.preview || "") && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(TextAreaComponent, (0, import_extends.default)({
